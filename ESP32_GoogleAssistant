...
#define WLAN_SSID       "nama_wifi"
#define WLAN_PASS       "password_wifi"
#define AIO_SERVER      "io.adafruit.com"
#define AIO_SERVERPORT  1883                  
#define AIO_USERNAME    "AIO_USERNAME"
#define AIO_KEY         "aio_oomn21RRC1xKQYjJjXXXXXXXXXXX"
...
void loop() {
  ...
  // main code untuk menghidupkan dan mematikan LED ketika menerima perintah dari google assistant
...
/* untuk penjelasan lebih detail bisa baca disini:
